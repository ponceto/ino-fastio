/*
 * FastIOBlink.ino - Copyright (c) 2014-2020 - Olivier Poncet
 *
...
struct Setup
{
    ...
    static constexpr uint8_t       PIN_NUMBER   = LED_BUILTIN;
    static constexpr uint8_t       PIN_MODE     = OUTPUT;
};
...
void loop()
{
    ...
    Serial.println(digitalPin.write(!digitalPin.read()));
    Serial.println(' ');
